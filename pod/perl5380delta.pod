...
This has resulted in two main type of problems in downstream CPAN
modules, and may also occur in your code:
...
If your code encounters and error on the stream while reading with
